...
|---------|-----|--------|--------|
| [Analogic pipeline](analogic/index.md) | `UDT_An_Pipeline` | Analogue pressure transmitter (PT) | Empty, Pressurised, With material, Clogged |
| [Digital pipeline](digital/index.md) | `UDT_Dig_Pipeline` | Two digital pressure switches (PSL / PSH) | Empty, With material, Clogged (+ Mismatch) |
