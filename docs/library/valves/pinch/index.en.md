...
Manual/automatic arbitration (`manual_mode`/`manual`/`auto`) follows the same pattern described in [Solenoid Valve](../solenoid/index.en.md).
...
|----|----------------------------|
| [`XV-E01`](../index.en.md#valve-alarms) | Current stable state (CLOSED/OPEN) not confirmed by `PSL` |
