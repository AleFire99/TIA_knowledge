...
Manual/automatic arbitration as in [Solenoid Valve](../../solenoid/index.en.md).
...
|----|----------------------------|
| [`XV-E01`](../../index.en.md#valve-alarms) | Current stable state not confirmed by the expected limit switch (`CLOSED` but `!ZSL`, or `OPEN` but `!ZSH`) |
| [`XV-E02`](../../index.en.md#valve-alarms) | `ZSL AND ZSH` TRUE at the same time |
| [`XV-E03`](../../index.en.md#valve-alarms) | `CLOSING` not confirmed within `actuator_timeout` |
| [`XV-E04`](../../index.en.md#valve-alarms) | `OPENING` not confirmed within `actuator_timeout` |
